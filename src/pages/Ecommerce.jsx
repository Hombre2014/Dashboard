...
//     <div className="mt-24">
//       <div className="flex flex-wrap lg:flex-nowrap justify-center ">
//         <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-6 m-3 bg-welcome-bg bg-no-repeat bg-cover bg-center">
//           <div className="flex justify-between items-center">
//             <div>
//               <p className='font-bold text-gray-400'>Earnings</p>
//               <p className='text-2xl'>$63,448.78</p>
...
//       </div>
//       <div className='flex gap-10 flex-wrap justify-center'>
//         <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg md:w-780 p-4 rounded-2xl m-3'>
//           <div className='flex justify-between'>
